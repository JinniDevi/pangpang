...
public class MemberVO {
	...
	private String  mem_passchanged;
	...
	public String getMem_passchanged() {
		return mem_passchanged;
	}
	public void setMem_passchanged(String mem_passchanged) {
		this.mem_passchanged = mem_passchanged;
	}
